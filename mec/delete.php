...
switch ($method) {
    ...
    case "DELETE":
        ...
        try {
            ...
            $sqlWorkers = "DELETE FROM mec_workers WHERE mec_id = :id";
            ...
            http_response_code(200);
            echo json_encode(['status' => 200, 'message' => 'MEC and associated workers deleted successfully.']);
        } catch (Exception $e) {
