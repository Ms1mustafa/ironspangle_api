...
switch ($method) {
    ...
    case "POST":
        ...
        $sql = "INSERT INTO company_expenses(item, unit, qty, unit_price, date, created_at, created_by) VALUES(:item, :unit, :qty, :unit_price, :date, :created_at, :created_by)";
    ...
    case "PUT":
        ...
        $sql = "UPDATE company_expenses SET item = :item, unit = :unit, qty = :qty, unit_price = :unit_price, date = :date WHERE id = :id";
        $stmt = $con->prepare($sql);
